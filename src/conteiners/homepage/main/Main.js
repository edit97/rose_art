        ...
        <div className={style.product}>
            <div className={style.bgkGray}>
                <div className={style.mainText}>
                    ...
                    <button className={style.btnProducts}>Продукт</button>
                </div>
            </div>
            ...
            <div className={style.bgkRed}>
                <div className={style.more}>
                    ...
                    <div className={style.text}>
                        <h1 className={style.textTitle}>О нас</h1>
                        <p className={style.someText}>Наши опытные разработчики могут воплотить любую вашу идею в реальность:
                            Опытная разработка может воплотить в жизнь все ваши идеи разработчиков и:
                            может воплотить все ваши идеи в  все ваши идеи:
                            разработчики могут воплотить в жизнь все ваши идеи в конце проекта.</p>
                        <button className={style.btnText}>БОЛЬШЕ ></button>
                    </div>
